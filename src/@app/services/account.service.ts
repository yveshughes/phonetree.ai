...
import { SfAccountVo } from "cybersafepolicy-core";
...
export class AccountService extends DbService {
    ...
    /* ************************************* Public Methods ******************************************** */
    public addUpdateAccount = async (vo: SfAccountVo): Promise<SfAccountVo> => {
        try {
            return await this.addUpdateRow<SfAccountVo>(this._sanatize(vo));
        } catch (error) {
            throw error;
        }
    }
